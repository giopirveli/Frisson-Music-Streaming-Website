          ...
          <div className={Style.controlBoxSecondPart}>
            ...
            <div className={Style.functionalIconsBox}>
              <button className={Style.functionalIconButton}>
                <Image src="/icons/Player/Shuflle.svg" alt="Shuflle" width={24} height={24} />
              </button>
              <button className={Style.functionalIconButton}>
                <Image
              ...
              <button className={Style.PlayPauseButton} onClick={togglePlay}>
                <Image
              ...
              <button className={Style.functionalIconButton}>
                <Image src="/icons/Player/PlayNext.svg" alt="PlayNext" width={24} height={24} />
              </button>
            ...
            <div className={Style.volumeControlBox}>
              <Image src="/icons/Player/Volume.svg" alt="Volume icon" width={24} height={24} />
              <input
                type="range"
                min={0}
                max={100}
