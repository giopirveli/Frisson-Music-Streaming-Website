...
const mockPlaylists: Playlist[] = [{ id: "1", name: "Playlist 1" },
        ...
        >
            {activeTab === 1 && (
                <div className={styles.Listbox} role="menu" aria-label="More options">
                    <button className={styles.ListboxBtn} role="menuitem" onClick={() => setActiveTab(2)}>
                        <Image src={"/icons/ThreeDots/disc.svg"} alt="" width={24} height={24} />
                        <span>Add to playlists</span>
                    </button>
                    <button className={styles.ListboxBtn} role="menuitem">
            ...
            {activeTab === 2 && (
                <div className={styles.playListbox} role="dialog" aria-label="Add To Playlist">
                    <div className={styles.playListboxHeader}>
                        <button className={styles.backBtn} aria-label="Go back" onClick={() => setActiveTab(1)}>
                            <Image src={arrow} width={20} height={20} alt="back" />
                        </button>
                        <span className={styles.title}>Add To Playlist</span>
                    </div>

                    <button className={styles.addPlayList} onClick={() => setActiveTab(3)}>
                        <Image src={"/icons/ThreeDots/ic_round-plus.svg"} alt="bal" width={20} height={20} /> New playlist
                    </button>

                    <div className={styles.playListboxContent}>
                        <form className={styles.playListboxContentForm}>
